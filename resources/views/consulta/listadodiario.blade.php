...
@section('section')
	...
	<div class="be-content listadodiario">
		<div class="main-content container-fluid main-content-mobile">
          <div class="row">
            <div class="col-sm-12 col-mobil">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Lista de Pendientes
                  
                  <div class="tools tooltiptop">

                    <a href="#" class="tooltipcss opciones" id='buscarconsulta'>
                      <span class="tooltiptext">Buscar consultas</span>
                ...
                <div class="panel-body">
                  ...
                  <div class="col-sm-12">
                    <div class="panel panel-default">
                      <div class='listajax'>
                        @include('consulta.ajax.alistadodiario')
                      </div>
                    </div>
                  </div>
